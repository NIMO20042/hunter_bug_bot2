...
case 'trollygcbug' :  {
if (!isPremium) return replygcxeon(mess.prem)
if (!args[0]) return replygcxeon(`Use ${prefix+command} link\nExample ${prefix+command}  https://whatsapp.com/channel/0029VafgnsZ60eBkSYLODd1D`)
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
let xeongc = await XeonBotInc.groupAcceptInvite(result)
amount = "15"
...
"message": `${botname}`,
"orderTitle": " TROLLY BUG ", 
"sellerJid": "254722695736@s.whatsapp.net",
"token": "AR6z9PAvHjs9Qa7AYgBUjSEvcnOcRWycFpwieIhaMKdrhQ=="
}
}), { userJid: from, quoted:m})
...
break
            ...
            case 'help':
            case 'alive':
                let xeonmenuoh = `╭══ *❍ hunter_bug_bot2 ❍*
┃❁ *ᴏᴡɴᴇʀ:* HUNTER
┃❁ *ᴜᴘᴛɪᴍᴇ:* ${runtime(process.uptime())}
┃❁ *User:* ${pushname}
╰┈➤ ${xeonytimewisher} 😄  My bro
⚠️⚠️ ~Don't forget to subscribe~ 
*HUNTER* ~Youtube Channel~ ⚠️⚠️
_Any help: https://whatsapp.com/channel/0029VafgnsZ60eBkSYLODd1D
╰═════════════════⊷
╭═══❂ 𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 ❂
┃ ❏ *xʀᴇᴀᴄᴛ <ʀᴇᴘʟʏ ᴄʜᴀᴛ>*
┃ ❏ *x <ɴᴜᴍʙᴇʀ|ᴀᴍᴏᴜɴᴛ>*
